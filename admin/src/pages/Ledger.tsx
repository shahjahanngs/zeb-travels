            ...
            <div className="mb-4 border-b border-gray-400 pb-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm"><span>Phone: 0313-5757057</span> | <span>Email: Travelerwasim@gmail.com</span></p>
                  <p className="text-sm">Office No: 2, Mezzanine Floor, Taimoor Chamber, Blue, Area G 6/2 Blue Area, Islamabad, 44000</p>
                </div>
              </div>
            </div>
